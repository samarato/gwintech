        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-stretch sm:items-center mb-8 md:mb-12 px-4">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-white text-primary-600 font-bold py-3 md:py-4 px-4 md:px-8 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 group text-sm md:text-base w-full sm:w-auto"
            >
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="border-2 border-white text-white font-bold py-3 md:py-4 px-4 md:px-8 rounded-full hover:bg-white hover:text-primary-600 transition-all duration-300 text-sm md:text-base w-full sm:w-auto"
            >
              <span className="flex items-center justify-center">
                <Phone className="w-4 h-4 md:w-5 md:h-5 mr-2" />
                <span>Call Now: +66 98 828 4666</span>
              </span>
            </motion.button>
          </div>
